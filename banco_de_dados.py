...
users = [
      ("Thay Rodrigues", "Thay", generate_password_hash("fitdance").decode('utf-8')),
      ("Maria Eduarda", "Duda", generate_password_hash("enfermagem").decode('utf-8')),
      ("Livia Vitoria", "Livia", generate_password_hash("rosa").decode('utf-8'))
]
